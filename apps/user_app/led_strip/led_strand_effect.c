...
void fc_static_effect(u8 n)
{
    ...
    fc_effect.rgb.w = (fc_static_map[n] >> 24) & 0xff;
...
{
    fc_effect.Now_state = IS_STATIC;
    fc_effect.rgb.r = (color >> 16) & 0xff;
    fc_effect.rgb.g = (color >> 8) & 0xff;
    fc_effect.rgb.b = (color) & 0xff;
    fc_effect.rgb.w = (color >> 24) & 0xff;
